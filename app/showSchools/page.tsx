  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <header className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white relative">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 py-3">
          ...
          <div className="text-sm flex items-center gap-2">
            ...
            <a href="mailto:mail@uniformapp.in" className="hover:underline font-bold">
              mail@uniformapp.in
            </a>
          </div>
          ...
          <nav className="hidden md:flex gap-4 text-sm font-bold items-center">
            <a href="#" className="hover:underline">Common Admissions</a>
            <a href="#" className="hover:underline">School Portal</a>
            <a href="#" className="hover:underline">Find Schools</a>
      ...
      <section className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold">Best Schools in Your City</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {schools.map((school: any) => (
            ...
            >
              ...
              />
              <div className="p-4">
                <h2 className="font-semibold text-lg text-gray-800">{school.name}</h2>
  ...
  <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
    ...
    <div>
      ...
      <ul className="mt-3 space-y-2 text-sm opacity-90">
        <li className="hover:text-white cursor-pointer">Schools in India</li>
        <li className="hover:text-white cursor-pointer">Other Schools</li>
        <li className="hover:text-white cursor-pointer">Colleges in India</li>
